...
export default function MatchedBooksVerticalList() {
  const [data, setData] = useState<BookListRowEntry[] | null>(null);
  ...
  return data == null ? (
    ...
    <VerticalList data={data} header="Twoje zmatchowane książki">
      <ListActionButton
        ...
        icon={<MessageIcon color={"#86A3D0"} size={28}/>}
      />
      <ListDeleteButton
...
export const MessageIcon = ({ color, size }: { color: ColorValue, size: NumberProp }) => {
  return (
    <Svg viewBox="0 0 640 512" width={size} height={size} fill={color}>
