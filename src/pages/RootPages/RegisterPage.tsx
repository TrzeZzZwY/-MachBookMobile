  ...
  return (
    <View className="h-[100vh] w-[100vw] flex items-center justify-center">
      <View className="mx-5 px-8 py-10 rounded-xl bg-white shadow-xl min-w-[85%]">
        <View>
          <CommonHeader
            text="Zarejestruj się do aplikacji"
            className="text-center text-lg color-neutral-700"
          />
          <CommonHeader
            text="MatchBook!"
        ...
        <View className="mt-8">
          <View className="flex items-center">
            <Pressable
              className="px-6 bg-neutral-900 py-3 rounded-md"
              onPress={handleRegisterUser}
            >
              <Text className="color-white font-roboto-bold">
                Zarejestruj się
              </Text>
            </Pressable>
          </View>
        ...
        <View className="mt-5">
          <Pressable className="w-full" onPress={navigateToLoginPage}>
            <Text className="text-center color-neutral-300">
              Posiadasz już konto?
            </Text>
            <Text className="text-center underline color-neutral-600 font-bold">
              Zaloguj się!
            </Text>
          </Pressable>
        </View>
